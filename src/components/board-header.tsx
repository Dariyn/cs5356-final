        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="px-3 py-1.5 bg-white border border-gray-300 rounded-md text-gray-700 text-sm hover:bg-gray-50"
            >
              Edit Board
            </button>
            <button
              onClick={handleDelete}
              className="px-3 py-1.5 bg-white border border-red-300 rounded-md text-red-600 text-sm hover:bg-red-50"
              disabled={isLoading}
            >
              Delete
            </button>
